 ...
 * @param time The ZonedDateTime to serialize
 * @param isSpecificDates Whether to format as `HHmm-DDMMYYYY` or `HHmm-d`
 * @returns Time serialized to UTC
 */
export const serializeTime = (time: Temporal.ZonedDateTime, isSpecificDates: boolean): string => {
